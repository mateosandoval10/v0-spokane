...
const activationDescriptions = {
  ...
  "Wing It Crossbar Challenge": "An Alaska/Hawaiian halftime crossbar attempt turns a soccer skill challenge into a travel-reward moment. The prize can scale from loyalty points to away-match tickets.",
  ...
  "Thomas Hammer Matchday Coldbrew Cart": "Thomas Hammer owns a visible coffee stop through matchday coldbrew carts, signature stadium drinks, and QR offers that can drive cafe visits after the match.",
  "Hammer Time Dance Cam": "A Hammer Time dance cam gives Thomas Hammer a recurring entertainment moment on the board, with drink cards, shirts, or cafe offers as the reward.",
  "Alaska Flight Crew Seat Upgrade": "An Alaska Flight Crew surprise upgrade moves a selected row or seat into premium seating, making the airline feel directly tied to a better matchday experience.",
  "LMNT Hydration Station": "LMNT can sample electrolyte packets, educate fans during hot matches, and connect player hydration content to direct purchase codes.",
  "NERF Golden Bolt Giveaway": "A hidden Golden Bolt under selected seats creates a simple arrival surprise and gives families a chance to win NERF prize packs or ticket bundles.",
  "On-Site Adopt-a-Pet": "Spokane Humane Society receives a dedicated adoption presence at the stadium, giving fans a direct way to meet adoptable animals and learn how to support the shelter.",
  "Animal Captain Coin Toss": "One adoptable animal becomes an honorary match captain, creating a simple pre-match ritual that can generate emotional content and adoption visibility.",
  ...
  "Bark at the Park": "A dog-friendly designated match connects ticketing, shelter visibility, and animal adoption into a full community event.",
  ...
  "#StaySaltySpokane Recharge Moment": "LMNT can own late-match energy through recharge graphics, hydration clips, and a social hashtag tied to recovery, cramps, and clutch moments.",
  ...
  "Yellow/Red Card Replay": "Lukins & Annis can own match-decision replay moments where rules, judgment, and legal language naturally connect.",
  "SHS Social Donation Campaign": "A social campaign turns fan posts and pet content into donation triggers or sponsor contributions for Spokane Humane Society.",
  ...
  "Thomas Hammer Community Roast": "A limited USL Spokane x Thomas Hammer roast creates a tangible take-home product with proceeds connected to youth soccer, schools, or other local causes.",
  "SHS Plushie Toss & Sale": "Custom SHS plushies create a tangible fundraising item through a halftime toss, limited sale, or donation add-on.",
  ...
  "Red Bull Earn Your Wings": "A Red Bull truck and hashtag campaign invites fans to share gameday support for a chance to win product packs or travel-adjacent prizes.",
  "SHS Ticket Donation Match": "A dedicated match sends a percentage of selected ticket proceeds or group sales to Spokane Humane Society.",
  ...
  "Women in the Workforce Night": "Lukins & Annis anchors a match-night community platform around women in the workforce, recognition, and professional leadership.",
